...
@Query("SELECT f FROM FicheFrais f WHERE f.user.id = :userId AND MONTH(f.dateModif) = :mois")
List<FicheFrais> findFichesByUserAndMois(@Param("userId") Long userId, @Param("mois") int mois);
